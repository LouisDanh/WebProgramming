	...
	<main class="my-4">
		<div class="container my-5">
			...
			<div class="mb-5">
				...
				<!-- content chu trình -->
				<div class="mb-5">
					<h2 class="h2 text-center mb-4 fs-1">Hoàn thiện chu trình
						dưỡng da hàng ngày</h2>
						...
						<div class="row justify-content-center gap-4">
							<div
								...
								<div class="position-absolute top-50 text-center">
									...
									<p class="small">Làm sạch da bằng sữa rửa mặt dịu nhẹ, đã
										tác dụng.</p>
									<p class="small">Massage khắp mặt bằng chuyển động tròn.
										Rửa sạch lại với nước.</p>
								</div>
							</div>
							<div
								class="col-12 col-md-2 d-flex flex-column align-items-center mb-4 position-relative">
								...
								<div class="position-absolute top-50 text-center">
									...
									<p class="small">Bước đầu giúp làn da được làm dịu và cấp
										ẩm đầy đủ.</p>
									<p class="small">Đổ nước dưỡng vào lòng bàn tay. Xoa đều
										hai bàn tay với nhau. Sau đó vỗ nhẹ lên má, cằm và trán. Hoặc,
										có thể sử dụng miếng bông thay thế.</p>
								</div>
							</div>
							<div
								class="col-12 col-md-2 d-flex flex-column align-items-center mb-4 position-relative">
								...
								<div class="position-absolute top-50 text-center ">
									...
									<p class="small">Massage lên mặt theo hình trái tim, bắt
										đầu từ giữa mặt & xuống cằm.</p>
								</div>
							</div>
							<div
								class="col-12 col-md-2 d-flex flex-column align-items-center mb-4 position-relative">
							...
							<div
								...
								<div class="position-absolute top-50 text-center">
									...
									<p class="small">Điều trị nhắm mục tiêu. Dưỡng ẩm phong
										phú, hiệu quả cao và nhẹ nhàng.</p>
									<p class="small">Dùng ngón áp út chấm 3 chấm. 1 ở góc
										ngoài, 1 ở giữa dưới mắt & 1 ở góc trong mắt. Vỗ nhẹ để thẩm
										thấu vào da.</p>
								</div>
							</div>
						</div>
				...
				<!-- content lão hóa -->
				<div class="mb-5">
					<h2 class="h2 text-center mb-4 fs-1">Chống lại các dấu hiệu
						lão hóa</h2>
					<p class="text-center mb-4">Nội dung cần chỉnh sửa</p>
					<div class="d-flex flex-row gap-3">
						<div class="card border-0">
